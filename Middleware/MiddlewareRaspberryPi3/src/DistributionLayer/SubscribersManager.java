...
public class SubscribersManager {
	...
	private static Map <String,ArrayList<SubscriberAddress>> subscribersList = new ConcurrentHashMap<String, ArrayList<SubscriberAddress>>();
	...
	public static void include(String topic, String sourceIP, int sourcePort){
		...
		if(subscribersList.get(topic) == null){
			ArrayList<SubscriberAddress> subscribers = new ArrayList<SubscriberAddress>();
